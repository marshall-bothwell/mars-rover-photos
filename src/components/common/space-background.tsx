...
//TODO:
//Use path and arc to draw circles instead of rectangles in putPixel()
//Add variation in size when making stars
...
export default function SpaceBackground(props: SpaceBackgroundProps) {
    ...
    return (
        <canvas id="space" className="fixed inset-0 z-[-1] opacity-100 mix-blend-screen pointer-events-none"></canvas>
    );
}
